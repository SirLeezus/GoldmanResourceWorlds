...
public enum Lang {
  ...
  COMMAND_HELP_LINE_1("&eThis server has three resource worlds. They reset"),
  COMMAND_HELP_LINE_2("&eevery 24 hours after the server restarts. You can"),
  COMMAND_HELP_LINE_3("&eaccess these worlds by running the command"),
  COMMAND_HELP_LINE_4("&3/resourceworld&e."),
